    ...
    <div className="min-h-screen">
      ...
      <section className="gradient-hero px-4 pb-16 pt-20 text-center text-white">
        ...
        >
          ...
          <h1 className="mb-4 text-4xl font-bold leading-tight font-[Space_Grotesk] md:text-5xl">
            Seus <span className="text-gradient">Reels</span> prontos
            <br />em 30 segundos
          </h1>
          <p className="mb-8 text-lg text-white/70">
            Roteiros, legendas e CTAs gerados por IA no estilo da sua marca.
            É só gravar.
          </p>
          <Button
            size="lg"
            className="gradient-primary border-0 px-8 text-base font-semibold shadow-lg"
      ...
      <section className="bg-background px-4 py-16">
        <div className="mx-auto max-w-lg">
          <h2 className="mb-8 text-center text-2xl font-bold font-[Space_Grotesk]">
      ...
      <section className="bg-muted/50 px-4 py-16">
        <div className="mx-auto max-w-lg text-center">
          <h2 className="mb-6 text-2xl font-bold font-[Space_Grotesk]">
            Funciona para o seu nicho
          </h2>
      ...
      <section className="bg-background px-4 py-16 text-center">
        <div className="mx-auto max-w-lg">
          <h2 className="mb-4 text-2xl font-bold font-[Space_Grotesk]">
          ...
          <Button
            size="lg"
            className="gradient-primary border-0 px-8 text-base font-semibold"
            onClick={() => navigate("/app/generate")}
          >
            Começar agora
          </Button>
